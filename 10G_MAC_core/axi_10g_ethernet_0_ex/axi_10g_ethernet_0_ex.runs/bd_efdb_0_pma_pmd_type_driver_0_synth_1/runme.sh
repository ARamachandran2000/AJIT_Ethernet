...
HD_PWD='/home/harshad/Project/git/AJIT_Ethernet/10G_MAC_core/axi_10g_ethernet_0_ex/axi_10g_ethernet_0_ex.runs/bd_efdb_0_pma_pmd_type_driver_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_efdb_0_pma_pmd_type_driver_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_efdb_0_pma_pmd_type_driver_0.tcl
