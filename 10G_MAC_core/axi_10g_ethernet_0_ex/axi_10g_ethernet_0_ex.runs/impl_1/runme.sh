...
HD_PWD='/home/harshad/Project/git/AJIT_Ethernet/10G_MAC_core/axi_10g_ethernet_0_ex/axi_10g_ethernet_0_ex.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_10g_ethernet_0_example_design.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source axi_10g_ethernet_0_example_design.tcl -notrace
