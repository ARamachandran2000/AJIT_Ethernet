...
HD_PWD='/home/harshad/Project/git/AJIT_Ethernet/10G_MAC_core/axi_10g_ethernet_0_ex/axi_10g_ethernet_0_ex.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_10g_ethernet_0_example_design.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_10g_ethernet_0_example_design.tcl
