...
################################################################
# This is a generated script based on design: bd_5d9f_0
#
...
if { $run_remote_bd_flow == 1 } {
  ...
  set origin_dir ./axi_ethernet_0_ex.srcs/sources_1/ip/axi_ethernet_0/bd_0
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net dummy_port_in_1 [get_bd_ports dummy_port_in] [get_bd_pins pcs_pma/dummy_port_in]
