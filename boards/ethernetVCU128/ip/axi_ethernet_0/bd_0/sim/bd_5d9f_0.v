...
//--------------------------------------------------------------------------------
//Command: generate_target bd_5d9f_0.bd
//Design : bd_5d9f_0
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_5d9f_0,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_5d9f_0,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=10,numReposBlks=10,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "axi_ethernet_0.hwdef" *) 
module bd_5d9f_0
   (axi_rxd_arstn,
    axi_rxs_arstn,
    axi_txc_arstn,
  ...
  assign dummy_port_in_1 = dummy_port_in;
  ...
  bd_5d9f_0_c_counter_binary_0_0 c_counter_binary_0
       (.CLK(s_axi_lite_clk_1),
        .SCLR(util_vector_logic_0_Res),
        .THRESH0(c_counter_binary_0_THRESH0));
  bd_5d9f_0_c_shift_ram_0_0 c_shift_ram_0
       (.CE(c_counter_binary_0_THRESH0),
        .CLK(s_axi_lite_clk_1),
        .D(xlconstant_0_dout),
        .Q(c_shift_ram_0_Q),
        .SCLR(util_vector_logic_0_Res));
  bd_5d9f_0_eth_buf_0 eth_buf
  ...
  bd_5d9f_0_util_vector_logic_0_0 util_vector_logic_0
       (.Op1(s_axi_lite_resetn_1),
        .Res(util_vector_logic_0_Res));
  bd_5d9f_0_xlconstant_0_0 xlconstant_0
       (.dout(xlconstant_0_dout));
  bd_5d9f_0_xlconstant_config_val_0 xlconstant_config_val
       (.dout(xlconstant_config_val_dout));
  bd_5d9f_0_xlconstant_config_vec_0 xlconstant_config_vec
       (.dout(xlconstant_config_vec_dout));
  bd_5d9f_0_xlconstant_phyadd_0 xlconstant_phyadd
