...
#
# Generated by export_simulation on Sat Apr 09 12:25:44 IST 2022
#
################################################################################
...
switch to the './fifo_generator_acb_resp.sh' script.

./fifo_generator_acb_resp.sh -reset_run
...
./fifo_generator_acb_resp.sh -noclean_files

For more information on the script, please type './fifo_generator_acb_resp.sh -help'.
