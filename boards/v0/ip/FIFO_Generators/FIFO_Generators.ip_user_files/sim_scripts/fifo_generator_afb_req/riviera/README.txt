...
#
# Generated by export_simulation on Sat Apr 09 12:26:37 IST 2022
#
################################################################################
...
switch to the './fifo_generator_afb_req.sh' script.

./fifo_generator_afb_req.sh -reset_run
...
./fifo_generator_afb_req.sh -noclean_files

For more information on the script, please type './fifo_generator_afb_req.sh -help'.
