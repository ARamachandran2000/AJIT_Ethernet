...
page_table_setup:
   ...
   st %g4, [%g3]
   ! g4 stored into [g3] 
   !PTE: context=0, index=0, level=3,  ppnr=0x8000, p_addr=0x0, cacheable=0x1, acc=0x3
   ! *(PAGE_TABLE_BASE + 0x0) = 0x88e (pte)
   set 0x88e, %g2
   set 0x0, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   ...
   st %g4, [%g3]
   ! g4 stored into [g3] 
   !PTD: context=0, index=63, level=2, child_p_addr=0x2c8, p_addr=0x3fc
   ...
   st %g4, [%g3]
   ! g4 stored into [g3] 
   !PTE: context=0, index=50, level=3,  ppnr=0x9000, p_addr=0x2c8, cacheable=0x1, acc=0x3
   ! *(PAGE_TABLE_BASE + 0x2c8) = 0x98e (pte)
   set 0x98e, %g2
   set 0x2c8, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
