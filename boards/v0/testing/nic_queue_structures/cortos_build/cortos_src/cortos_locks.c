...
uint8_t* lockStartAddr   = 0xc000;
uint8_t* lockStartAddrNc = 0xd000; // non-cacheable
...
void cortos_init_locks() {
  ...
  uint8_t* lockStartAddr   = (uint8_t*)0xc000;
  uint8_t* lockStartAddrNc = (uint8_t*)0xd000; // non-cacheable
