...
page_table_setup:
   ...
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=1, level=1,  ppnr=0x1000000, p_addr=0x804, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x804) = 0x100016 (pte)
   set 0x100016, %g2
   set 0x804, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=2, level=1,  ppnr=0x2000000, p_addr=0x808, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x808) = 0x200016 (pte)
   set 0x200016, %g2
   set 0x808, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=3, level=1,  ppnr=0x3000000, p_addr=0x80c, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x80c) = 0x300016 (pte)
   set 0x300016, %g2
   set 0x80c, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTD: context=0, index=4, level=1, child_p_addr=0x200, p_addr=0x810
   ! *(PAGE_TABLE_BASE + 0x810) = ptd(PAGE_TABLE_BASE + 0x200)
   ! make PTD from 0x200
   set 0x200, %g4
   add %g1, %g4, %g4
   srl %g4, 0x4, %g4
   ...
   st %g4, [%g3]
   ! g4 stored into [g3] 
   !PTE: context=0, index=0, level=2,  ppnr=0x4000000, p_addr=0x200, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x200) = 0x400016 (pte)
   set 0x400016, %g2
   set 0x200, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=1, level=2,  ppnr=0x4040000, p_addr=0x204, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x204) = 0x404016 (pte)
   set 0x404016, %g2
   set 0x204, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=2, level=2,  ppnr=0x4080000, p_addr=0x208, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x208) = 0x408016 (pte)
   set 0x408016, %g2
   set 0x208, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=3, level=2,  ppnr=0x40c0000, p_addr=0x20c, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x20c) = 0x40c016 (pte)
   set 0x40c016, %g2
   set 0x20c, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=4, level=2,  ppnr=0x4100000, p_addr=0x210, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x210) = 0x410016 (pte)
   set 0x410016, %g2
   set 0x210, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=5, level=2,  ppnr=0x4140000, p_addr=0x214, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x214) = 0x414016 (pte)
   set 0x414016, %g2
   set 0x214, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=6, level=2,  ppnr=0x4180000, p_addr=0x218, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x218) = 0x418016 (pte)
   set 0x418016, %g2
   set 0x218, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=7, level=2,  ppnr=0x41c0000, p_addr=0x21c, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x21c) = 0x41c016 (pte)
   set 0x41c016, %g2
   set 0x21c, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=8, level=2,  ppnr=0x4200000, p_addr=0x220, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x220) = 0x420016 (pte)
   set 0x420016, %g2
   set 0x220, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=9, level=2,  ppnr=0x4240000, p_addr=0x224, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x224) = 0x424016 (pte)
   set 0x424016, %g2
   set 0x224, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=10, level=2,  ppnr=0x4280000, p_addr=0x228, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x228) = 0x428016 (pte)
   set 0x428016, %g2
   set 0x228, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=11, level=2,  ppnr=0x42c0000, p_addr=0x22c, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x22c) = 0x42c016 (pte)
   set 0x42c016, %g2
   set 0x22c, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=12, level=2,  ppnr=0x4300000, p_addr=0x230, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x230) = 0x430016 (pte)
   set 0x430016, %g2
   set 0x230, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=13, level=2,  ppnr=0x4340000, p_addr=0x234, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x234) = 0x434016 (pte)
   set 0x434016, %g2
   set 0x234, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=14, level=2,  ppnr=0x4380000, p_addr=0x238, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x238) = 0x438016 (pte)
   set 0x438016, %g2
   set 0x238, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=15, level=2,  ppnr=0x43c0000, p_addr=0x23c, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x23c) = 0x43c016 (pte)
   set 0x43c016, %g2
   set 0x23c, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=16, level=2,  ppnr=0x4400000, p_addr=0x240, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x240) = 0x440016 (pte)
   set 0x440016, %g2
   set 0x240, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=17, level=2,  ppnr=0x4440000, p_addr=0x244, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x244) = 0x444016 (pte)
   set 0x444016, %g2
   set 0x244, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=18, level=2,  ppnr=0x4480000, p_addr=0x248, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x248) = 0x448016 (pte)
   set 0x448016, %g2
   set 0x248, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=19, level=2,  ppnr=0x44c0000, p_addr=0x24c, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x24c) = 0x44c016 (pte)
   set 0x44c016, %g2
   set 0x24c, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=20, level=2,  ppnr=0x4500000, p_addr=0x250, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x250) = 0x450016 (pte)
   set 0x450016, %g2
   set 0x250, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=21, level=2,  ppnr=0x4540000, p_addr=0x254, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x254) = 0x454016 (pte)
   set 0x454016, %g2
   set 0x254, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=22, level=2,  ppnr=0x4580000, p_addr=0x258, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x258) = 0x458016 (pte)
   set 0x458016, %g2
   set 0x258, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=23, level=2,  ppnr=0x45c0000, p_addr=0x25c, cacheable=0x0, acc=0x5
   ! *(PAGE_TABLE_BASE + 0x25c) = 0x45c016 (pte)
   set 0x45c016, %g2
   set 0x25c, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
