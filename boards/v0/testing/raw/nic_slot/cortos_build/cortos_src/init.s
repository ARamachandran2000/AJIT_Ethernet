...
SETUP_THREAD_0_0:
  ...
  set 0x351ffa0, %sp  ! set stack address
  clr %fp
...
__cortos_init_region_to_zero:
  ...
  sethi %hi(0x2600000), %l0
  or %l0, %lo(0x2600000), %l0

  ! set the first illegal address
  sethi %hi(0x3500000), %l2
  or %l2, %lo(0x3500000), %l2
...
_cortos_zero_init_area_BssSection:
  ...
  ! set the base address
  sethi %hi(0x3500000), %l0
  or %l0, %lo(0x3500000), %l0

  ! set the first illegal address
  sethi %hi(0x3501000), %l2
  or %l2, %lo(0x3501000), %l2
  sub %l2, 0x4, %l2         ! address of last valid word location
...
_cortos_zero_init_area_CacheableLocks:
  ...
  ! set the base address
  sethi %hi(0x3501000), %l0
  or %l0, %lo(0x3501000), %l0

  ! set the first illegal address
  sethi %hi(0x3502000), %l2
  or %l2, %lo(0x3502000), %l2
  sub %l2, 0x4, %l2         ! address of last valid word location
