...
set rt::rc [catch {
  uplevel #0 {
    ...
    set ::env(RT_TMP) "./.Xil/Vivado-26347-ajit4-ProLiant-ML10/realtime/tmp"
    ...
    if {$rt::useElabCache == false} {
      ...
      ./.Xil/Vivado-26347-ajit4-ProLiant-ML10/realtime/clk_wiz_1_stub.v
      ...
      rt::read_vhdl -lib ahir /home/harshad/Project/git/IITB_AI_ML/ahir_release/vhdl/ahir.vhdl
      rt::read_vhdl -lib ahir_ieee_proposed /home/harshad/Project/git/IITB_AI_ML/ahir_release/vhdl/aHiR_ieee_proposed.vhdl
    ...
    set rt::SDCFileList ./.Xil/Vivado-26347-ajit4-ProLiant-ML10/realtime/top_level_synth.xdc
    rt::sdcChecksum
...
# MODE: 
    rt::set_parameter webTalkPath {./.Xil/Vivado-26347-ajit4-ProLiant-ML10/wt}
    rt::set_parameter enableSplitFlowPath "./.Xil/Vivado-26347-ajit4-ProLiant-ML10/"
