set_property SRC_FILE_INFO {cfile:/home/harshad/Project/git/AJIT_Ethernet/boards/v0/vivado_synth/.Xil/Vivado-26347-ajit4-ProLiant-ML10/dcp3/clk_wiz_1_in_context.xdc rfile:../dcp3/clk_wiz_1_in_context.xdc id:1 order:EARLY scoped_inst:clocking1} [current_design]
...
set_false_path -through [get_pins DualClockedQueue_ACB_req_instance/dual_clock_fifo/U0/rst] -to [get_pins [list DualClockedQueue_ACB_req_instance/dual_clock_fifo/U0/inst_fifo_gen/gconvfifo.rf/grf.rf/rstblk/grstd1.grst_full.grst_f.rst_d1_reg/PRE \
...
set_false_path -through [get_pins DualClockedQueue_ACB_resp_inst/dual_clock_fifo/U0/rst] -to [get_pins [list DualClockedQueue_ACB_resp_inst/dual_clock_fifo/U0/inst_fifo_gen/gconvfifo.rf/grf.rf/rstblk/grstd1.grst_full.grst_f.rst_d1_reg/PRE \
...
set_false_path -through [get_pins DualClockedQueue_AFB_req_inst/dual_clock_fifo/U0/rst] -to [get_pins [list DualClockedQueue_AFB_req_inst/dual_clock_fifo/U0/inst_fifo_gen/gconvfifo.rf/grf.rf/rstblk/grstd1.grst_full.grst_f.rst_d1_reg/PRE \
...
set_false_path -through [get_pins DualClockedQueue_AFB_resp_inst/dual_clock_fifo/U0/rst] -to [get_pins [list DualClockedQueue_AFB_resp_inst/dual_clock_fifo/U0/inst_fifo_gen/gconvfifo.rf/grf.rf/rstblk/grstd1.grst_full.grst_f.rst_d1_reg/PRE \
