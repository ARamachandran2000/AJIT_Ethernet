set_property SRC_FILE_INFO {cfile:/home/harshad/Project/git/AJIT_Ethernet/boards/v0/vivado_synth/.Xil/Vivado-38254-ajit4-ProLiant-ML10/dcp3/clk_wiz_1_in_context.xdc rfile:../dcp3/clk_wiz_1_in_context.xdc id:1 order:EARLY scoped_inst:clocking1} [current_design]
...
create_generated_clock -name clocking1/clk_out2 -source [get_ports clk_p] -edges {1 2 3} -edge_shift {0.000 4.196 8.392} [get_pins clocking1/clk_out2]
