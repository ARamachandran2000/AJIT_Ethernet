...
set genomeRtd $env(RT_TMP)/107B9B90.rtd
...
rt::set_parameter parallelChildUpdateCell true; rt::set_parameter parallelTimingMode true; rt::set_parameter parallelTimingModeRound 1; set rt::SDCFileList ./.Xil/Vivado-7650-ajit4-ProLiant-ML10/realtime/tmp/parallel_timing.xdc; 
