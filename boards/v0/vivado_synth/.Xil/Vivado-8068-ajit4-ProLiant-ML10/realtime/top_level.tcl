...
set rt::rc [catch {
  uplevel #0 {
    ...
    set ::env(RT_TMP) "./.Xil/Vivado-8068-ajit4-ProLiant-ML10/realtime/tmp"
    ...
    if {$rt::useElabCache == false} {
      ...
      ./.Xil/Vivado-8068-ajit4-ProLiant-ML10/realtime/clk_wiz_1_stub.v
    ...
    set rt::SDCFileList ./.Xil/Vivado-8068-ajit4-ProLiant-ML10/realtime/top_level_synth.xdc
    rt::sdcChecksum
